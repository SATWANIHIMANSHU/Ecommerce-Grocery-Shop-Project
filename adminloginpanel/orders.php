    ...
    <div class="br-sideleft">
        ...
        <ul class="custom-scroll">
            <li ><a href="main.php" class="waves-effect waves-primary"><i
                        ...
                        <li class="active"><a href="orders.php" class="waves-effect waves-primary"><i class="la la-check-circle"></i>Orders</a></li>
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo '<th>Total Amount</th>';  // New column for total amount
    echo '<th>Action</th>';  
    echo '</tr>';
    echo '</thead>';
    echo '<tbody>';
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        if (mysqli_num_rows($item_result) > 0) {
            ...
            while ($item_row = mysqli_fetch_assoc($item_result)) {
                ...
                $total_amount += $item_row['Quantity'] * $item_row['Price'];
            }
        ...
        echo '<td>';
        echo '<div class="btn-group" role="group" style="width:100%;">';  // Grouping buttons
        echo '<a href="view_invoice.php?order_id=' . $row['Order_id'] . '" class="btn btn-info w-50 mr-1">View Invoice</a>'; // View Invoice button with same width
        echo '<a href="download.php?order_id=' . $row['Order_id'] . '" class="btn btn-primary w-50">Download Invoice</a>'; // Download Invoice button with same width
        echo '</div>';
        echo '</td>';
