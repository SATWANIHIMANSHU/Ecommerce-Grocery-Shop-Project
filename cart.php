...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<style>
		table {
			border: 0;
			width: 80%;
			/* Adjust this to control table width */
			margin: 20px auto;
		...
		<div class="container">
			...
			<div class="container">
             ...
             foreach($_SESSION['cart'] as $key => $value) {
                ...
                // Optionally use $key for dynamic serial numbers if needed.
                echo "
                <tr>
                    <td>" . ($key + 1) . "</td> <!-- Display dynamic serial number -->
...
?>
				<div class="pay col-lg-3">
					<div class="payment-box  ">
						...
						<form action="orderplacing.php" method="POST">
							<button type="submit" class=" purchase-button btn btn-primary " <?php if ($isCartEmpty) echo 'disabled' ; ?>>
								Make Purchase
							</button>
						</form>
						<!-- <button class="purchase-button">Make Purchase</button> -->
					</div>
				</div>
			</div>
		</div>
