...
<!-- <div class="load">
	...
	<div class="faqs-w3l">
		<div class="container">
			...
			<div class="wthree-help">
				<div class="col-xs-7 agile-left-help">
					...
					<form action="save_query.php" method="post" id="queryForm">
        ...
        <input type="submit" value="Submit">
			...
			<div class="faq-w3agile">
				...
				<ul class="faq">
					<li class="item1">
						<a href="#" title="click here">Account & Registration</a>
						<ul>
							<li class="subitem1">
								<strong>Do I need to create an account to shop?</strong>
								<p>Yes, creating an account allows you to track your orders, manage deliveries, and receive personalized offers.</p>
							</li>
							<li class="subitem1">
								<strong>How do I create an account?</strong>
								<p>1. Click on the "Sign Up" button at the top of the homepage.</p>
								<p>2. Enter your email address, create a password, and fill in your details.</p>
								<p>3. ou will receive a confirmation email to activate your account.</p>
							</li>

						</ul>
					</li>
					<li class="item2">
						<a href="#" title="click here">Placing an Order</a>
						<ul>
							<li class="subitem1">
								<strong>How do I place an order on the website?</strong>
								<p>1. Browse products through our categories or use the search bar to find specific items.</p>
								<p>2. Click "Add to Cart" on the items you wish to purchase.</p>
								<p>3. Once you’re ready, click on the shopping cart icon to review your selected items.</p>
								<p>4. Click "Checkout," sign in to your account (or create one), and follow the steps to confirm your order.</p>
							</li>
						</ul>
					</li>
					<li class="item3">
						<a href="#" title="click here">Products & Availability</a>
						<ul>
							<li class="subitem1">
								<strong>What kinds of products do you sell?</strong>
								<p>We offer a wide range of grocery items, including fresh produce, dairy, bakery items, packaged goods, household essentials, and more.</p>
								<strong>How can I check if a product is in stock?</strong>
								<p>The product availability is listed on the product page. If a product is out of stock, you’ll see an "Out of Stock" notification.</p>
								<strong>Do you offer organic, gluten-free, or other dietary-specific products?</strong>
								<p>Yes, you can filter your search based on dietary preferences like organic, gluten-free, vegan, and more using the filter options on the product page.</p>
							</li>
						</ul>
					</li>
					<li class="item4">
						<a href="#" title="click here"> Payments & Billing</a>
						<ul>
							<li class="subitem1">
								<strong>What payment methods do you accept?</strong>
								<p>We accept a variety of payment methods, including:Cash on Delivery (in selected areas),Credit/Debit Cards (Visa, MasterCard, American Express).</p>
								<strong>Is it safe to use my credit card on your website?</strong>
								<p>Yes, we use secure SSL encryption to protect your payment details and comply with international payment standards.</p>
							</li>
						</ul>
					</li>
					<li class="item5">
						<a href="#" title="click here">Delivery & Shipping</a>
						<ul>
							<li class="subitem1">
								<strong>Where do you deliver?</strong>
								<p>We deliver to most locations within our designated service areas. Enter your zip code on our homepage to check if we deliver to your location.</p>
								<strong>How much does delivery cost?</strong>
								<p>Delivery charges depend on your location and the total amount of your order. Orders over a certain threshold may qualify for free delivery.</p>
								<strong>When will my order be delivered?</strong>
								<p>During checkout, you can choose from available delivery time slots. Our deliveries usually take place between 8 AM and 8 PM, and you will receive a notification once your delivery is out for dispatch.</p>
    ...
    <script>
        // Auto-trigger the modal when the form is successfully submitted
