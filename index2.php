...
<body>
	...
	<div class="ads-grid">
				...
				<div class="men-pro-item simpleCart_shelfItem">
					<form action="managecart.php" method="POST">
						...
						<div class="item-info-product ">
							...
							<div class="info-product-price">
								<span class="item_price">₹520.00</span>
								<del>₹600.00</del>
							</div>
							<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							<!-- <form action="#" method="post">
					...
					<form action="managecart.php" method="POST">
						...
						<div class="item-info-product ">
						    ...
						    <div class="snipcart-details top_brand_home_details     item_add single-item hvr-outline-out">
								...
								<input type="submit" name="Add_To_Cart" value="Add to cart" class="button" />
								<input type="hidden" name="Item_Name" value="Freedom Oil, 1L">
		...
		<div class="product-sec1">
					   ...
					   <div class="row">
						   <?php
include('adminloginpanel/dbconnect.php');  // Database connection
				...
				<ul id="flexiselDemo1">
					<li>
						...
						<form action="managecart.php" method="POST">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="single.php">Aashirvaad, 5kg</a>
								</h4>
								...
								<div
									...
									<input type="submit" name="Add_To_Cart" value="Add to cart" class="button">
								<input type="hidden" name="Item_Name" value="Aashirvaad, 5kg">
					...
					<li>
						...
						<form action="managecart.php" method="POST">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="single.php">Madhur Pure Sugar, 1kg</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>₹69.00</h6>
									<p>Save ₹20.00</p>
								...
								<div
									...
									<input type="submit" name="Add_To_Cart" value="Add to cart" class="button">
								<input type="hidden" name="Item_Name" value="Madhur Pure Sugar, 1kg">
						...
						<form action="managecart.php" method="POST">
							...
							<div class="product-name-w3l">
								...
								<div
									...
									<input type="submit" name="Add_To_Cart" value="Add to cart" class="button">
								<input type="hidden" name="Item_Name" value="Surf Excel Liquid, 1.02L">
								<input type="hidden" name="Price" value="187.00">
							</div> 
								</div>
					...
					<li>
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="single2.html">Fair & Lovely, 80g</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>₹121.60</h6>
									<p>Save ₹30.00</p>
								...
								<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
									...
									<input type="submit" name="Add_To_Cart" value="Add to cart" class="button" />
							<input type="hidden" name="Item_Name" value="Fair & Lovely, 80g">
						...
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								...
								<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
									...
									<input type="submit" name="Add_To_Cart" value="Add to cart" class="button" />
							<input type="hidden" name="Item_Name" value="Lakme Eyeconic Kajal, 0.35g">
							<input type="hidden" name="Price" value="399.99">
								</div>
							</div>
						</form>
	...
	<footer>
		<div class="container">
			...
			<p class="footer-main">
				...
				magni dolores eos qui ratione voluptatem sequi nesciunt.Sed ut perspiciatis unde omnis iste natus
