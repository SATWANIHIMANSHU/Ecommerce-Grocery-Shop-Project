...
<!-- <div class="load">
	...
	<div class="contact-w3l">
				...
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="purchase.php" method="post">
							...
							<div class="">
                                Phone_no:
								<input class="number" type="text" name="phone_no"   min="10" max="10"required="">
							</div>
							<div class="">
                                Email:
        ...
        Mode of Payment
        <input type="text" class="form-control" id="modeofpayment" name="modeofpayment" value="COD" readonly>
    </div> -->
							<button class="btn btn-primary" name="purchase">Make Order</button>
						</form>
					</div>
