...
$showModal=true;
		...
		if($pass==$cpass){
			...
			$sql="INSERT INTO `smartbazar` (`name`,`email`, `password`) VALUES ( '$uname','$email','$hash')";
			$result=mysqli_query($conn,$sql);
			if($result){
				echo "<script>
					...
					<div class="contact agileits">
						<div class="contact-agileinfo">
							<div class="contact-form wthree">
								...
								<form action="/web/signup.php" method="post" id="registrationForm">
									<div class="form-group ">
										<label for="name">Username</label>
										<input type="text" maxlength="30" class="form-control" id="name" name="name"
											aria-describedby="emailHelp" style="width: 100%;" required>
									...
									<div class="form-group">
										...
										<input type="password" maxlength="260" class="form-control" id="password"
											name="password" required>
									</div>
									<div class="form-group">
										<label for="cpassword">Confirm Password</label>
										<input type="password" maxlength="260" class="form-control" id="cpassword"
											name="cpassword" required>
										<span id="passwordError" class="error"></span>
									</div>

									<button type="submit" class="btn btn-primary submit-btn" id=submiBtn>Sign
										Up</button>
								</form>
							</div>
