				...
				<ul>
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item  " id="dropdown-item" href="profile.php">Profile</a>
							<hr>
							<!-- <a class="dropdown-item " href="#">My Orders</a><hr> -->

							<a class="dropdown-item " href="profile.php">My Orders</a>
							<hr>
							...
							<ul class="slides">
								<li data-thumb="images/si.jpg">
									<div class="thumb-image">
										<img src="images/si.jpg" data-imagezoom="true" class="img-responsive" alt="">
									</div>
								</li>
								<li data-thumb="images/si2.jpg">
									<div class="thumb-image">
										<img src="images/si2.jpg" data-imagezoom="true" class="img-responsive" alt="">
									</div>
								</li>
								<li data-thumb="images/si3.jpg">
									<div class="thumb-image">
										<img src="images/si3.jpg" data-imagezoom="true" class="img-responsive" alt="">
									</div>
								</li>
							</ul>
							<div class="clearfix"></div>
			...
			<div class="col-md-7 single-right-left simpleCart_shelfItem">
				...
				<div class="product-single-w3l">
					...
					<ul>
						...
						<li>
							After cooking, Zeeba Basmati rice grains attain an extra ordinary length of upto 2.4 cm/~1
							inch.
						</li>
						<li>
							Zeeba Basmati rice adheres to the highest food afety standards as your health is paramount
							to us.
						</li>
						<li>
				...
				<div class="occasion-cart">
					<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
						...
						<input type="submit" name="Add_To_Cart_Single_Product" value="Add to cart" class="button">
						<input type="hidden" name="Item_Name" value="Zeeba Premium Basmati Rice - 5 KG">
